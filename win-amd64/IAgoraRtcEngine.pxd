...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef enum LOCAL_VIDEO_STREAM_STATE:
		LOCAL_VIDEO_STREAM_STATE_STOPPED = 0
		LOCAL_VIDEO_STREAM_STATE_CAPTURING = 1
		LOCAL_VIDEO_STREAM_STATE_ENCODING = 2
		LOCAL_VIDEO_STREAM_STATE_FAILED = 3
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef enum LOCAL_VIDEO_STREAM_ERROR:
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef enum RTMP_STREAM_PUBLISH_STATE:
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef enum RTMP_STREAM_PUBLISH_ERROR:
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef enum AUDIO_CODEC_PROFILE_TYPE:
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef cppclass ScreenCaptureParameters:
		...
		ScreenCaptureParameters(VideoDimensions& x1,int x2,int x3,bool x4) except +
		ScreenCaptureParameters(int x1,int x2,int x3,int x4,bool x5) except +
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef cppclass IRtcEngineEventHandler:
		...
		void onFirstRemoteAudioDecoded(uid_t x1,int x2)
		void onVideoDeviceStateChanged(char *x1,int x2,int x3)
		void onLocalVideoStateChanged(int x1,int x2)
		...
		void onRtmpStreamingStateChanged(char *x1,RTMP_STREAM_PUBLISH_STATE x2,RTMP_STREAM_PUBLISH_ERROR x3)
		...
		void onAudioRouteChanged(AUDIO_ROUTE_TYPE x1)
		...
		void onNetworkTypeChanged(NETWORK_TYPE x1)
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef cppclass IMetadataObserver:
		enum METADATA_TYPE:
			UNKNOWN_METADATA = -1
			VIDEO_METADATA = 0
		cppclass Metadata:
		...
		bool onReadyToSendMetadata(Metadata& x1)
		void onMetadataReceived(Metadata& x1)
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc::IMetadataObserver":
		enum METADATA_TYPE:
			UNKNOWN_METADATA = -1
			VIDEO_METADATA = 0
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc::IMetadataObserver":
...
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
	cdef cppclass IRtcEngine:
		...
		int startScreenCaptureByScreenRect(Rectangle& x1,Rectangle& x2,ScreenCaptureParameters& x3)
		...
		int registerMediaMetadataObserver(IMetadataObserver*x1,METADATA_TYPE x2)
cdef extern from "include/IAgoraRtcEngine.h"namespace "agora::rtc":
...
cdef extern from "EventHandlerWrapper.h":
	cdef cppclass EventHandler:
		...
		void onRemoteAudioTransportStats(uid_t x1,unsigned short x2,unsigned short x3,unsigned short x4)
		void onRemoteVideoTransportStats(uid_t x1,unsigned short x2,unsigned short x3,unsigned short x4)
cdef extern from "include/IAgoraMediaEngine.h":
