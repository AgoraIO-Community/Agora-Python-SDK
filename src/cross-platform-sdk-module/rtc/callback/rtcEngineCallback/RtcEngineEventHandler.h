...
namespace agora
{
	...
	{
#if defined(_WIN32)
		typedef void(__stdcall *FUNC_OnJoinChannelSuccess)(const char *, rtc::uid_t uid, int elapsed);
		typedef void(__stdcall *FUNC_OnReJoinChannelSuccess)(const char *, rtc::uid_t uid, int elapsed);
		...
		typedef void(__stdcall *FUNC_OnFirstRemoteVideoDecoded)(rtc::uid_t uid, int width, int height, int elapsed);
		typedef void(__stdcall *FUNC_OnVideoSizeChanged)(rtc::uid_t uid, int width, int height, int elapsed);
		...
		typedef void(__stdcall *FUNC_OnFirstRemoteAudioFrame)(rtc::uid_t userId, int elapsed);
		typedef void(__stdcall *FUNC_OnLastmileQuality)(int quality);
		typedef void(__stdcall *FUNC_OnAudioQuality)(rtc::uid_t userId, int quality, unsigned short delay, unsigned short lost);
		typedef void(__stdcall *FUNC_OnStreamInjectedStatus)(const char *url, rtc::uid_t userId, int status);
		...
		typedef void(__stdcall *FUNC_OnStreamMessageError)(rtc::uid_t userId, int streamId, int code, int missed, int cached);
		typedef void(__stdcall *FUNC_OnStreamMessage)(rtc::uid_t userId, int streamId, const char *data, size_t length);
		typedef void(__stdcall *FUNC_OnConnectionBanned)();
		typedef void(__stdcall *FUNC_OnRemoteVideoTransportStats)(rtc::uid_t uid, unsigned short delay, unsigned short lost, unsigned short rxKBitRate);
		typedef void(__stdcall *FUNC_OnRemoteAudioTransportStats)(rtc::uid_t uid, unsigned short delay, unsigned short lost, unsigned short rxKBitRate);
		...
		typedef void(__stdcall *FUNC_OnNetworkQuality)(rtc::uid_t uid, int txQuality, int rxQuality);
		...
		typedef void(__stdcall *FUNC_OnRemoteVideoStats)(rtc::uid_t uid, int delay, int width, int height, int receivedBitrate, int decoderOutputFrameRate, int rendererOutputFrameRate, int packetLossRate, int rxStreamType, int totalFrozenTime, int frozenRate, int totalActiveTime);
		typedef void(__stdcall *FUNC_OnRemoteAudioStats)(rtc::uid_t uid, int quality, int networkTransportDelay, int jitterBufferDelay, int audioLossRate, int numChannels, int receivedSampleRate, int receivedBitrate, int totalFrozenTime, int frozenRate, int totalActiveTime);
		...
		typedef void(__stdcall *FUNC_OnFirstRemoteVideoFrame)(rtc::uid_t uid, int width, int height, int elapsed);
		...
		typedef void(__stdcall *FUNC_OnRemoteVideoStateChanged)(rtc::uid_t uid, int state, int reason, int elapsed);
		typedef void(__stdcall *FUNC_OnUserEnableLocalVideo)(rtc::uid_t uid, bool enabled);
		typedef void(__stdcall *FUNC_OnLocalPublishFallbackToAudioOnly)(bool isFallbackOrRecover);
		typedef void(__stdcall *FUNC_OnRemoteSubscribeFallbackToAudioOnly)(rtc::uid_t uid, bool isFallbackOrRecover);
		typedef void(__stdcall *FUNC_OnConnectionStateChanged)(int state, int reason);
		typedef void(__stdcall *FUNC_OnLocalUserRegistered)(rtc::uid_t uid, const char* userAccount);
		typedef void(__stdcall *FUNC_OnUserInfoUpdated)(rtc::uid_t uid, rtc::uid_t userId, char* userAccount);
		typedef void(__stdcall *FUNC_OnLocalAudioStateChanged)(int state, int error);
		typedef void(__stdcall *FUNC_OnRemoteAudioStateChanged)(rtc::uid_t uid, int state, int reason, int elapsed);
		typedef void(__stdcall *FUNC_OnStreamInjectedStatus)(const char* url, rtc::uid_t uid, int status);
		...
		typedef void(__stdcall *FUNC_OnFirstRemoteAudioDecoded)(rtc::uid_t uid, int elapsed);
		...
		typedef void(__stdcall *FUNC_OnChannelJoinChannelSuccess)(const char* channelId, rtc::uid_t uid, int elapsed);
		typedef void(__stdcall *FUNC_OnChannelReJoinChannelSuccess)(const char* channelId, rtc::uid_t uid, int elapsed);
		...
		typedef void(__stdcall *FUNC_OnChannelUserJoined)(const char* channelId, rtc::uid_t uid, int elapsed);
        typedef void(__stdcall *FUNC_OnChannelUserOffLine)(const char* channelId, rtc::uid_t uid, int reason);
		...
		typedef void(__stdcall *FUNC_OnChannelNetworkQuality)(const char* channelId, rtc::uid_t uid, int txQuality, int rxQuality);
        typedef void(__stdcall *FUNC_OnChannelRemoteVideoStats)(const char* channelId, rtc::uid_t uid, int delay, int width, int height, int receivedBitrate, int decoderOutputFrameRate, int rendererOutputFrameRate, int packetLossRate, int rxStreamType, int totalFrozenTime, int frozenRate, int totalActiveTime);
        typedef void(__stdcall *FUNC_OnChannelRemoteAudioStats)(const char* channelId, rtc::uid_t uid, int quality, int networkTransportDelay, int jitterBufferDelay, int audioLossRate, int numChannels, int receivedSampleRate, int receivedBitrate, int totalFrozenTime, int frozenRate, int totalActiveTime);
		typedef void(__stdcall *FUNC_OnChannelRemoteAudioStateChanged)(const char* channelId, rtc::uid_t uid, int state, int reason, int elapsed);
		typedef void(__stdcall *FUNC_OnChannelActiveSpeaker)(const char* channelId, rtc::uid_t uid);
		typedef void(__stdcall *FUNC_OnChannelVideoSizeChanged)(const char* channelId, rtc::uid_t uid, int width, int height, int rotation);
		typedef void(__stdcall *FUNC_OnChannelRemoteVideoStateChanged)(const char* channelId, rtc::uid_t uid, int state, int reason, int elapsed);
		typedef void(__stdcall *FUNC_OnChannelStreamMessage)(const char* channelId, rtc::uid_t uid, int streamId, const char* data, size_t length);
		typedef void(__stdcall *FUNC_OnChannelStreamMessageError)(const char* channelId, rtc::uid_t uid, int streamId, int code, int missed, int cached);
		...
		typedef void(__stdcall *FUNC_OnChannelStreamInjectedStatus)(const char* channelId, const char* url, rtc::uid_t uid, int status);
		typedef void(__stdcall *FUNC_OnChannelRemoteSubscribeFallbackToAudioOnly)(const char* channelId, rtc::uid_t uid, bool isFallbackOrRecover);
