...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.beauty_on_btn = QtWidgets.QPushButton(self.centralwidget)
        self.beauty_on_btn.setGeometry(QtCore.QRect(550, 10, 90, 30))
        self.beauty_on_btn.setObjectName("beauty_on_btn")
        self.beauty_off_btn = QtWidgets.QPushButton(self.centralwidget)
        self.beauty_off_btn.setGeometry(QtCore.QRect(650, 10, 90, 30))
        self.beauty_off_btn.setObjectName("beauty_off_btn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.beauty_on_btn.setText(_translate("MainWindow", "Beauty On"))
        self.beauty_off_btn.setText(_translate("MainWindow", "Beauty Off"))
