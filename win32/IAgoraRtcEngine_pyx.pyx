...
cdef class pyVideoCanvas:
	...
	@priv.setter
	def priv(self, unsigned int priv):
...
cdef class pyIVideoDeviceManager:
	...
	def enumerateVideoDevices(self):
		...
		return tmp
	def startDeviceTest(self,unsigned int x1):
...
cdef class pyAudioFrame:
	...
	@buffer.setter
	def buffer(self, unsigned int buffer):
